...
class Product:
    def __init__(self, name, price, currency, date_time_scrap, external_product_id, url_img=None, thumb_url_img=None,
...
class ScrapConfigurator:
    def __init__(self, company_id, scrap_with, product_name_path, product_price_path, product_thumb_img_path,
        ...
        self.external_product_id_path = external_product_id_path
